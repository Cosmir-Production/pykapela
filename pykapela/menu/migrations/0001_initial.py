# Generated by Django 3.0.8 on 2020-07-30 14:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, help_text='Parent site tree item.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='menuitem_parent', to='menu.MenuItem', verbose_name='Parent')),
                ('tree', models.ForeignKey(help_text='Site tree this item belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='menuitem_tree', to='sitetree.Tree', verbose_name='Site Tree')),
            ],
            options={
